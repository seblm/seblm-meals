...
docker run --rm --tty \
  ...
  sbtscala/scala-sbt:eclipse-temurin-25.0.1_8_1.12.6_3.8.2 sbt "Docker / stage"
```
...
```shell
┌  Welcome to SvelteKit CLI! (v0.12.7)
│
...
●  npx sv create@0.12.7 --template minimal --types ts --add prettier eslint sveltekit-adapter="adapter:static" --install npm frontend
│
