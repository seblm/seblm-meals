...
libraryDependencies += "org.playframework" %% "play" % "3.0.11"
libraryDependencies += "org.playframework" %% "play-configuration" % "3.0.11"
...
libraryDependencies += "org.postgresql" % "postgresql" % "42.7.11" % Runtime
